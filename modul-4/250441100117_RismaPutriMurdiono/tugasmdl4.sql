CREATE DATABASE sandbox_siakad;
USE sandbox_siakad
...
FOREIGN KEY (id_mk) REFERENCES mata_kulia(id_mk)
);
...
JOIN mata_kulia mk ON k.id_mk = mk.id_mk
...
WHERE m.angkatan BETWEEN 2023 AND 2025
  AND (d.nama_dosen LIKE 'Dr. Budi%' OR d.nama_dosen LIKE 'Prof. Siti%')
