...
FROM mata_kuliah mk JOIN dosen d 
...
ON m.id_mahasiswa = k.id_mahasiswa
 JOIN mata_kuliah mk 
ON k.id_mk = mk.id_mk
WHERE m.program_studi = 'Sistem Informasi' AND (mk.sks > 2 OR mk.sks IS NULL)
...
JOIN dosen d
ON mk.id_dosen = d.id_dosen
WHERE angkatan BETWEEN 2023 AND 2025 AND d.nama_dosen IN ("Dr. Budi","Prof. Siti")
