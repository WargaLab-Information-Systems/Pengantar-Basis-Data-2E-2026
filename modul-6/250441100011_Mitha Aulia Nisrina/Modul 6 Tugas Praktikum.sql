-- TUGAS PRAKTIKUM PBD (MODUL 6) SUBQUERY DAN VIEW.
...
-- 1. Tampilkan daftar mahasiswa (nim, nama, nilai_angka) yang memiliki nilai di atas rata-rata nilai angka seluruh mahasiswa pada tabel Nilai.
...
-- 2. Tampilkan daftar mata kuliah (kode_mk, nama_mk) yang pernah diambil oleh mahasiswa bernama 'Budi Santoso'.
...
-- 3. Tampilkan daftar mahasiswa (nim, nama) dari tabel Mahasiswa yang sudah memiliki data nilai di tabel Nilai. Gunakan operator EXISTS untuk memeriksa keberadaan data tersebut.
SELECT m.nim, m.nama
FROM mahasiswa m
WHERE EXISTS
(
...
-- 4. Hitunglah rata-rata nilai mahasiswa khusus untuk mata kuliah yang memiliki kode 'MK01' dan 'MK02' dengan menggunakan subquery pada klausa FROM sebagai tabel sementara.
...
-- 5. a. Buatlah sebuah VIEW bernama v_transkrip_lengkap yang menggabungkan data dari tabel Mahasiswa, Mata Kuliah, dan Nilai. Tampilkan kolom: nim, nama_mahasiswa, nama_mk, dan nilai_huruf.
...
-- b. Gunakan VIEW tersebut untuk menampilkan hanya mahasiswa yang mendapatkan nilai 'A'.
SELECT *
