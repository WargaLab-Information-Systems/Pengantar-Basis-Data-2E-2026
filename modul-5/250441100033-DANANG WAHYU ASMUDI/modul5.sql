...
JOIN mata_kuliah ON krs.kode_mk = mata_kuliah.kode_mk
GROUP BY krs.nim
HAVING SUM(mata_kuliah.sks) > 5;


-- no5
SELECT sks,
COUNT(*)Total_MK,
SUM(sks)Total_Akumulasi_SKS
FROM mata_kuliah
GROUP BY sks
HAVING COUNT(*) > 1;